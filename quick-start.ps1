...
function Show-Menu {
    ...
    Write-Host "  2. 构建开发环境" -ForegroundColor White -NoNewline
    Write-Host " (构建前端)" -ForegroundColor Gray
    Write-Host "  3. 运行应用" -ForegroundColor White -NoNewline
    Write-Host " (开发模式)" -ForegroundColor Gray
    Write-Host ""
    
    Write-Host "【打包发布】" -ForegroundColor Yellow
    Write-Host "  4. PyInstaller 打包" -ForegroundColor White -NoNewline
    ...
    Write-Host "  6. Nuitka 打包" -ForegroundColor White -NoNewline
    Write-Host " (目录模式)" -ForegroundColor Gray
    ...
    Write-Host "  8. 清理打包缓存" -ForegroundColor White -NoNewline
    Write-Host ""
